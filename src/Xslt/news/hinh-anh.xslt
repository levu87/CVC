...
<xsl:output method="html" indent="yes"/>
    ...
    <xsl:template match="News" mode="Big">
        <xsl:if test="position() = 1">
            <div class="new-item new-item--1"><a data-fancybox="image">
            ...
            <div class="video"> 
                <div class="button">
                <img src="/Data/Sites/1/media/picture.png">
    ...
    <xsl:template match="News" mode="Small">
        <xsl:if test="position() =2">
            <div class="new-item new-item--2"> <a data-fancybox="image">
            ...
            <div class="video"> 
                ...
                <img src="/Data/Sites/1/media/picture.png" alt="">
                </img>
                </div>
                <img class="lazyload blur-up">
                <xsl:attribute name="src">
    ...
    <xsl:template match="News" mode="Small2">
        <xsl:if test="position() =2">
            <div class="new-item new-item--3"> <a data-fancybox="image">
    ...
    <xsl:template match="News" mode="List">
        <xsl:if test="position() &gt; 3">
            ...
            <div class="video"> 
                <div class="button"> <img src="/Data/Sites/1/media/picture.png" alt=""></img></div>
                <img class="lazyload blur-up">
                <xsl:attribute name="src">
                    <xsl:value-of select="ImageUrl"></xsl:value-of>
                </xsl:attribute>
