...
<xsl:output method="html" indent="yes"/>
				...
				<div class="container"> 
					...
					<div class="list-item"> 
                            ...
                            <div class="item item--2">
							    ...
							    <xsl:apply-templates select="/ZoneList/Zone" mode="small-1"></xsl:apply-templates>
							...
							<xsl:apply-templates select="/ZoneList/Zone" mode="small2"></xsl:apply-templates>
    ...
    <xsl:template match="Zone" mode="small2">
    ...
    <xsl:template match="Zone" mode="small-1">
